...
public class Main {
	...
	public static final int NUMBER_OF_DAYS_2 = 256;
	...
	public static void main(String[] args) {
		...
		if (inputFileURL == null) {
			...
			try {
				EfficientLanternfishSimulator simulator = EfficientLanternfishSimulator.fromFile(
				...
				simulator.newDays(NUMBER_OF_DAYS_2 - NUMBER_OF_DAYS);

				System.out.println(String.format("After %d days, there are %d lanternfish in the school", NUMBER_OF_DAYS_2, simulator.getNumberOfFish()));
